...
toast_opacity = 0;
toast.style = "opacity:" + toast_opacity;
time.innerHTML = new Date();
refreshIntervalId = setInterval(time_setter, 990);

window.addEventListener("resize", function() {
    let h = header.offsetHeight + 10 + "px";
...
function home_maker() {
    return `<div id="home_section">
                <div class="profile">
                    ...
                    <h3 class="my_name">Shravan Sharma</h3>
                    <h5>MTech</h5>
                    ...
                    <tr>
                        <td rowspan="5">
                            <table class="left_table">
                                ...
                                <tr>
                                    <td>
                                        <a href="#" class="fa fa-google" onclick="copy_mail_id()"></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <a target="_blank" href="https://www.linkedin.com/in/shravan-sharma-93a5a5194/" class="fa fa-linkedin"></a>
                                ...
                                <tr>
                                    <td>
                                        <a href="#" class="fa fa-phone" onclick="copy_phone_num()"><!-- </a><span>   </span><span>9755769503</span> -->
                                    </td>
                                </tr>
                            </table>
...
function copy_mail_id() {
    /* Get the text field */
    var mail_id = "shravan.sharma9977@gmail.com";
    if (toast_opacity > 0) {
        stop_toast();
    ...
    navigator.clipboard.writeText(mail_id);

    /* Alert the copied text */
    toast.innerHTML = "Mail ID copied to clipboard";
    toast_opacity = 1.0;
    toast.style = "opacity:" + toast_opacity;

    refreshIntervalId = setInterval(function() {
        toast_opacity = toast_opacity - 0.03;
        toast.style = "opacity:" + toast_opacity;
        if (toast_opacity <= 0) {
            stop_toast();
        }
...
function copy_phone_num() {
    /* Get the text field */
    var contact_num = "+919755769503";
    if (toast_opacity > 0) {
        stop_toast();
        toast.style = "opacity:0";
    }
    ...
    /* Copy the text inside the text field */
    navigator.clipboard.writeText(contact_num);
